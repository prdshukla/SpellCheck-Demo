...
#Region "Properties"
    ...
    ''' <summary>
    ''' This Property can be set from Form level. The System omit the Captilization Rules if this property is False.
...
#End Region
    ...
    ''' <summary>
    ''' This Method is to set the Skin Properties
    ''' </summary>
    ''' <remarks></remarks>
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub CustomTextEdit_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.Validating
        Dim objTextEdit As CustomTextEdit = CType(sender, CustomTextEdit)
    ...
    ' ''' <param name="e"></param>
    ' ''' <remarks></remarks>
    Private Sub CustomTextEdit_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If Not CType(sender, CustomTextEdit).OffCapsValidation Then
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub CustomTextEdit_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub CustomTextEdit_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.EditValueChanged
